...
import {
  ...
  FibrousGlassDustTraining,
  BinderResinSizingTraining,
  GlassMatLineLOTOTraining,
...
const PROGRAMS = [
  ...
  {
    path:       '/glass-melt-furnace-safety',
    ...
    minutes:    22,
    Component:  GlassMeltFurnaceTraining,
  },
  {
    path:       '/marble-melt-feed-furnace-charging',
    ...
    minutes:    18,
    Component:  MarbleMeltFeedTraining,
  },
  {
    path:       '/forehearth-hot-glass-transfer',
    ...
    minutes:    18,
    Component:  ForehearthTransferTraining,
  },
  {
    path:       '/fiberizing-spinner-attenuation',
    ...
    minutes:    20,
    Component:  FiberizingSpinnerTraining,
  },
  {
    path:       '/mat-forming-line-safety',
    ...
    minutes:    18,
    Component:  MatFormingLineTraining,
  },
  {
    path:       '/fibrous-glass-dust-irritation',
    label:      'Fibrous Glass Dust & Irritation Awareness',
    short:      'Fiber Contact, Eye/Skin Protection, and Cleanup Control',
    icon:       '🫧',
    color:      '#00D1C1',
    regulation: 'Awareness Only — Fibrous glass dust, irritation, and housekeeping awareness',
    audience:   'All personnel entering fiberglass production, finishing, cleanup, or maintenance areas',
    minutes:    16,
    Component:  FibrousGlassDustTraining,
  },
  {
    path:       '/binder-resin-sizing-chemical-safety',
    ...
    minutes:    20,
    Component:  BinderResinSizingTraining,
  },
  {
    path:       '/glass-mat-line-loto',
    ...
    minutes:    20,
    Component:  GlassMatLineLOTOTraining,
  },
...
function getProgramCategory(path) {
  ...
  const glassFiberglass = new Set(['/glass-melt-furnace-safety', '/marble-melt-feed-furnace-charging', '/forehearth-hot-glass-transfer', '/fiberizing-spinner-attenuation', '/mat-forming-line-safety', '/fibrous-glass-dust-irritation', '/binder-resin-sizing-chemical-safety', '/glass-mat-line-loto'])
...
function getProgramType(path) {
  ...
  const highRisk = new Set(['/loto', '/loto-campus', '/h2s', '/arcflash', '/molten-metal', '/furnace-melt-deck', '/crane-ladle', '/propane-farm', '/confined-space', '/hot-work', '/machine-guarding', '/adult-cpr-awareness', '/aed-awareness', '/pulse-check-awareness', '/severe-bleeding-control', '/heat-illness', '/glass-melt-furnace-safety', '/marble-melt-feed-furnace-charging', '/forehearth-hot-glass-transfer', '/fiberizing-spinner-attenuation', '/binder-resin-sizing-chemical-safety', '/glass-mat-line-loto'])
