...
const PROGRAMS = [
  ...
  },
  {
    ...
    icon:       '🌡️',
    color:      '#FF6B00',
    regulation: 'Awareness Only — Recognize symptoms, cool rapidly, and activate site response',
    audience:   'All campus personnel, foundry crews, outdoor workers, maintenance, and support teams',
    minutes:    18,
    Component:  HeatIllnessTraining,
  },
  {
    path:       '/stroke-fast',
    label:      'Stroke Recognition (FAST)',
    short:      'Facial Droop, Arm Weakness, Speech Changes, and Time to Act',
    icon:       '🧠',
    color:      '#7C4DFF',
    regulation: 'Awareness Only — Recognize stroke signs and activate EMS immediately',
    audience:   'All campus personnel, public teams, office staff, and escorts',
    minutes:    12,
    Component:  StrokeFASTTraining,
  },
  {
    path:       '/heart-attack-warning',
    label:      'Heart Attack Warning Signs',
    short:      'Chest Pain, Pressure, Collapse Risk, and Immediate Escalation',
    icon:       '💓',
    color:      '#FF3366',
    regulation: 'Awareness Only — Recognize warning signs and activate EMS without delay',
    audience:   'All campus personnel, supervisors, public teams, and response-support staff',
    minutes:    12,
    Component:  HeartAttackWarningTraining,
  },
  {
    path:       '/burn-first-aid',
    label:      'Burn First Aid',
    short:      'Thermal, Chemical, and Contact Burn Response Awareness',
    icon:       '🔥',
    color:      '#FF8A00',
    regulation: 'Awareness Only — Immediate cooling, escalation, and approved response actions',
    audience:   'Foundry, kitchens, maintenance, sanitation, retail, and all support teams',
    minutes:    12,
    Component:  BurnFirstAidTraining,
  },
  {
    path:       '/eye-exposure',
    label:      'Eye Exposure / Chemical Splash Response',
    short:      'Immediate Flushing, Eyewash Use, and Escalation',
    icon:       '👁️',
    color:      '#00C853',
    regulation: 'Awareness Only — Flush immediately and follow site exposure-response procedure',
    audience:   'Chemical users, sanitation, maintenance, food plant, lab, and cleanup teams',
    minutes:    12,
    Component:  EyeExposureTraining,
  },
